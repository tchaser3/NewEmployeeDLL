...
namespace NewEmployeeDLL {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class employeesDataTable : global::System.Data.TypedTableBase<employeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public employeesRow AddemployeesRow(int EmployeeID, string FirstName, string LastName, string PhoneNumber, bool Active, string EmployeeGroup, string HomeOffice, string EmployeeType, string EmailAddress) {
        ...
        public partial class employeesRow : global::System.Data.DataRow {
            ...
            public string EmployeeGroup {
                get {
                    return ((string)(this[this.tableemployees.EmployeeGroupColumn]));
                }
                set {
                    this[this.tableemployees.EmployeeGroupColumn] = value;
                }
            }
...
namespace NewEmployeeDLL.EmployeesDataSetTableAdapters {
    ...
    public partial class employeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[employees] ([EmployeeID], [FirstName], [LastName], [PhoneNumber], [Active], [EmployeeGroup], [HomeOffice], [EmployeeType], [EmailAddress]) VALUES (@EmployeeID, @FirstName, @LastName, @PhoneNumber, @Active, @EmployeeGroup, @HomeOffice, @EmployeeType, @EmailAddress);
SELECT EmployeeID, FirstName, LastName, PhoneNumber, Active, EmployeeGroup, HomeOffice, EmployeeType, EmailAddress FROM employees WHERE (EmployeeID = @EmployeeID)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@EmployeeGroup", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "EmployeeGroup", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@HomeOffice", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "HomeOffice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employees] SET [EmployeeID] = @EmployeeID, [FirstName] = @FirstName, [LastName] = @LastName, [PhoneNumber] = @PhoneNumber, [Active] = @Active, [EmployeeGroup] = @EmployeeGroup, [HomeOffice] = @HomeOffice, [EmployeeType] = @EmployeeType, [EmailAddress] = @EmailAddress WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Active] = @Original_Active));
SELECT EmployeeID, FirstName, LastName, PhoneNumber, Active, EmployeeGroup, HomeOffice, EmployeeType, EmailAddress FROM employees WHERE (EmployeeID = @EmployeeID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@EmployeeGroup", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "EmployeeGroup", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@HomeOffice", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "HomeOffice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, FirstName, LastName, PhoneNumber, Active, EmployeeGroup, HomeO" +
                "ffice, EmployeeType, EmailAddress FROM dbo.employees";
        ...
        public virtual int Delete(int Original_EmployeeID, bool Original_Active) {
        ...
        public virtual int Insert(int EmployeeID, string FirstName, string LastName, string PhoneNumber, bool Active, string EmployeeGroup, string HomeOffice, string EmployeeType, string EmailAddress) {
            ...
            if ((EmployeeGroup == null)) {
                throw new global::System.ArgumentNullException("EmployeeGroup");
            }
            else {
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(EmployeeGroup));
            }
            if ((HomeOffice == null)) {
                throw new global::System.ArgumentNullException("HomeOffice");
            }
            else {
                this.Adapter.InsertCommand.Parameters[6].Value = ((string)(HomeOffice));
            }
            if ((EmployeeType == null)) {
                throw new global::System.ArgumentNullException("EmployeeType");
            }
            else {
                this.Adapter.InsertCommand.Parameters[7].Value = ((string)(EmployeeType));
            }
        ...
        public virtual int Update(int EmployeeID, string FirstName, string LastName, string PhoneNumber, bool Active, string EmployeeGroup, string HomeOffice, string EmployeeType, string EmailAddress, int Original_EmployeeID, bool Original_Active) {
            ...
            if ((EmployeeGroup == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(EmployeeGroup));
            }
            if ((HomeOffice == null)) {
                throw new global::System.ArgumentNullException("HomeOffice");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(HomeOffice));
            }
            if ((EmployeeType == null)) {
                throw new global::System.ArgumentNullException("EmployeeType");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(EmployeeType));
            }
            if ((EmailAddress == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string PhoneNumber, bool Active, string EmployeeGroup, string HomeOffice, string EmployeeType, string EmailAddress, int Original_EmployeeID, bool Original_Active) {
            return this.Update(Original_EmployeeID, FirstName, LastName, PhoneNumber, Active, EmployeeGroup, HomeOffice, EmployeeType, EmailAddress, Original_EmployeeID, Original_Active);
        }
    }
